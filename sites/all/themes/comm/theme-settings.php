...
function comm_form_system_theme_settings_alter(&$form, &$form_state) {
  ...
  $form['sticky_nav_image']['settings']['sticky_nav_path'] = array(
    ...
    '#default_value' => theme_get_setting('sticky_nav_path'), //isset(theme_get_setting('sticky_nav_path')) ? theme_get_setting('sticky_nav_path') : NULL,
  );
  ...
  $form['footer_contact_us']['settings']['footer_contact_us_comm1_title'] = array(
    '#type' => 'textfield',
    '#title' => t('Agency Title'),
    '#description' => t('Commercial title for the Contact Us block.'),
    '#default_value' => theme_get_setting('footer_contact_us_comm1_title'),
  );
