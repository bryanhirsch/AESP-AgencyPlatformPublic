...
jQuery(window).load(function() {//window.load instead of document.ready because I need images to have loaded before measuring sizes
	...
	jQuery('body').bind('responsivelayout', function(e, d) {
		...
		layout = d.to;
		//used by event handlers to determine current layout
...
jQuery(document).ready(function() {
	...
	function footer() {
		...
		if (contactBlock.clientHeight - 40 > footerInfo.clientHeight) {
			footerInfo.style.height = (contactBlock.clientHeight - 40).toString().concat('px');
		}
	}
	footer();
